  ...
  return (
    <main className='py-[2rem] flex flex-col min-h-screen'>
      ...
      <div className='mb-[75px] flex flex-col gap-5'>
        <h2 className='text-[2.5rem] font-bold'>{questions[activeQuestion].question}</h2>
      <p className='text-tertiary text-[1.2rem]'>
        Select all that apply
      </p>
      </div>
      <QuestionList answers={questions[activeQuestion].answers} handleNext={handleNext} checkedCount={checkedCount} handleCheck={handleCheck} />
